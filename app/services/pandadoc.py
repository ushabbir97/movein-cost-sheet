...
from pandadoc_client.model.document_create_request_recipients import (
...
API_KEY = "88b916b3ce1f5ad364b7d47c5ac179395a0923c1"
...
def create_document_from_sample_template_pdf_url(api_instance):
    document_create_request = DocumentCreateRequest(
        ...
        recipients=[
            ...
            DocumentCreateRequestRecipients(
                email="luqmanhaider919@gmail.com",
                first_name="John",
                last_name="Doe",
                signing_order=2,
            ),
